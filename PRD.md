...
- Subscribe Page
  ...
  - Users can subscribe to a channel by clicking on the subscribe button. On clicking the subscribe button, the user is subscribed to the channel and the button text changes to Unsubscribe.
  ...
  - Users can see the list of videos/podcasts for a channel by clicking on the channel name
    - We show the list of videos/podcasts in a grid layout
...
- We show a sceleton loader of Summary Card on button click
...
- On the summary card, the user should see:
  ...
  - **Show Transcript** button, which allows the user to see the transcript of the video. We show a sceleton loader on button click. The button is disabled until the transcript is shown. The reason for this is that the transcript and summaries are shown on the same card and we don't want to show the transcript again if it is already shown.
  - **Show Detailed Summary or Show Brief Summary** button, which allows the user to see the detailed summary of the video. We generate the detailed summary on button click if it is not already generated. We show a sceleton loader on button click. Once the detailed summary is generated, the button text changes to 'Show Brief Summary'. When user clicks on this button, we show the brief summary of the video on the card that was generated previously.
...
- Chat interface should be present below the summary card.
- User should be able to ask questions about the video/podcast.
- User should be able to ask follow up questions.
...
- Users can search for summaries using the following:
  - **Title of the video/podcast**
  - **Channel name**
  - **Terms from the summaries**.
  - **Tags associated with the video**.
...
- Chunking of the transcript should be done based on the length of the transcript.

## 10. Future Enhancements

- We will add a **feed** of all the summaries from the channels that the user is subscribed to.
- We will add a **feed** of all the summaries based on the topics that the user is interested in.
- User should be able to share the summary card on social media.
- We will add a **search bar** to the top navigation bar to search for videos/podcasts.
